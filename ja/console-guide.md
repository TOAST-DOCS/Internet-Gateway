...
## Network > Internet Gateway > コンソール使用ガイド { #network-internet-gateway-console-user-guide }

コンソールからInternet Gatewayサービスを使用する方法を説明します。

<a id="management"></a>
## インターネットゲートウェイの管理 { #management }
<a id="create"></a>
### インターネットゲートウェイの作成 { #create }
...
### サーバーメンテナンスのためのインターネットゲートウェイ再起動 { #restarting-guide-for-maintenance }
