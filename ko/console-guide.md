...
## Network > Internet Gateway > 콘솔 사용 가이드 { #network-internet-gateway-console-user-guide }

콘솔에서 Internet Gateway 서비스를 사용하는 방법을 설명합니다.

<a id="management"></a>
## 인터넷 게이트웨이 관리 { #management }
<a id="create"></a>
### 인터넷 게이트웨이 생성 { #create }
...
### 서버 점검을 위한 인터넷 게이트웨이 재시작 { #restarting-guide-for-maintenance }
